...
def getFromAPI():
    ...
    mysql_vault_token = # Insert Token for Authenticating for legacy_mysql_role here!
    ...
    # Much Success! Interpolate MySQL credentials from Vault API request and serve to STDOUT:
    if(resp.ok):
        print ""
        print "-----------------------------------------------"
